// Code generated by easyjson for marshaling/unmarshalling. DO NOT EDIT.
...
// MarshalJSON supports json.Marshaler interface
func (u DSUser) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCfe4e5f0EncodeGithubComFrancoispqtGojayBenchmarks1(&w, u)
	return w.Buffer.BuildBytes(), w.Error
}

// MarshalEasyJSON supports easyjson.Marshaler interface
func (u DSUser) MarshalEasyJSON(w *jwriter.Writer) {
	easyjsonCfe4e5f0EncodeGithubComFrancoispqtGojayBenchmarks1(w, u)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (u *DSUser) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonCfe4e5f0DecodeGithubComFrancoispqtGojayBenchmarks1(&r, u)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (u *DSUser) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCfe4e5f0DecodeGithubComFrancoispqtGojayBenchmarks1(l, u)
}
